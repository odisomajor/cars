...
export async function PATCH(
  ...
  try {
    ...
    if (!title || !make || !model || !year || !price || !location || !condition || !fuelType || !transmission) {
      return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    // Delete the listing (this will cascade delete favorites and other related records)
